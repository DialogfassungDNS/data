...
<div>
  <div class="my-header">
    <label class="default"><i class="fa fa-wrench" aria-hidden="true"></i> Indikatoren wurden methodisch oder inhaltlich angepasst.<br>Die aktuelle Version finden Sie <a href"http://dns-indikatoren.de/1-1-ab/">hier</a>.
    </label>
  </div>
</div>
